...
export function AdminUsersPage() {
  ...
  const { data: detail, isLoading: isDetailLoading } = useAdminUserDetail(
    selectedUser?.id
  );
      ...
      <PageTransition>
        <div data-testid="admin-users-page">
          ...
          <SlideOverPanel
            ...
            description="Read-only kullanıcı, personel ve aktivasyon dossier."
                ...
                <div className="space-y-md">
                  ...
                  <section className="rounded-panel border border-accent/20 bg-accent-bg/60 p-md">
                    ...
                    <p className="mt-sm text-caption text-text-secondary">
                      Davet linki gerekiyorsa Admin Users ekranından işlem
                      yapılmaz; Personel detayındaki güvenli akış kullanılır.
                    </p>
                  </section>
